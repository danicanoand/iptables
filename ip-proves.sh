...
#netB
#netDMZ
iptables -t nat -A POSTROUTING -s 172.22.0.0/24 -o wlp2s0 -j MASQUERADE
iptables -t nat -A POSTROUTING -s 172.23.0.0/24 -o wlp2s0 -j MASQUERADE
iptables -t nat -A POSTROUTING -s 172.24.0.0/24 -o wlp2s0 -j MASQUERADE
